...
<br>      `},{name:"Божко Сергій",img:k,link:"./bozhko-serhii/bozhko-serhii.html",desc:`
      ...
      Спортсмен кіокушинкай карате<br>
      Народився 24 травня 2004 року у с. Мар’янівка`},{name:"Томащук Віталій",img:G,link:"./tomashchuk-vitalii/tomashchuk-vitalii.html",desc:`
      Спортсмен кіокушинкай карате<br>
      <br>`},{name:"Ярмоленко Віктор",img:f,link:"./yarmolenko-viktor/yarmolenko-viktor.html",desc:`
      Спортсмен кіокушинкай карате<br>
      Народився 2 січня 1976 року в м. Київ`}],_=document.querySelector(".gallery-ul");w.forEach(o=>{const n=document.createElement("li");n.classList.add("gallery-list"),n.innerHTML=`
