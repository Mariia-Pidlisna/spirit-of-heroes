...
<br>      `},{name:"Божко Сергій",img:k,link:"./bozhko-serhii/bozhko-serhii.html",desc:`
      ...
      Спортсмен кіокушинкай карате<br>
      Народився 2 січня 1976 року в м. Київ`}],_=document.querySelector(".gallery-ul");G.forEach(o=>{const n=document.createElement("li");n.classList.add("gallery-list"),n.innerHTML=`
